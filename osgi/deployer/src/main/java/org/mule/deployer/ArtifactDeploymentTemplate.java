...
public interface ArtifactDeploymentTemplate
{
    ...
    public final ArtifactDeploymentTemplate NOP_ARTIFACT_DEPLOYMENT_TEMPLATE = new ArtifactDeploymentTemplate()
    {
        ...
        @Override
        public void preRedeploy(ArtifactBundle artifact)
        {
            // Nothing to do
        }

        @Override
        public void postRedeploy(ArtifactBundle artifact)
        {
            // Nothing to do
        }
    };
     ...
     */
    void preRedeploy(ArtifactBundle artifact);
     ...
     */
    void postRedeploy(ArtifactBundle artifact);
