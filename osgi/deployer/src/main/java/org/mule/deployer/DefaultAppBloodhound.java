...
import org.mule.deployer.api.descriptor.DescriptorParser;
import org.mule.deployer.api.descriptor.EmptyApplicationDescriptor;
import org.mule.deployer.api.descriptor.PropertiesDescriptorParser;
...
public class DefaultAppBloodhound implements AppBloodhound
{
    ...
    {
        final File appsDir = MuleFoldersUtil.getAppsFolder();
