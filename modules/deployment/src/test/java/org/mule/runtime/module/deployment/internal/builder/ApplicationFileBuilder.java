...
public class ApplicationFileBuilder extends AbstractArtifactFileBuilder<ApplicationFileBuilder> {
  ...
  public ApplicationFileBuilder definedBy(String configFile) {
    ...
    this.resources.add(new ZipResource(configFile, ApplicationDescriptor.DEFAULT_CONFIGURATION_RESOURCE));
  ...
  protected List<ZipResource> getCustomResources() throws Exception {
    ...
    final ZipResource appProperties =
        createPropertiesFile(this.properties, ApplicationDescriptor.DEFAULT_APP_PROPERTIES_RESOURCE);
