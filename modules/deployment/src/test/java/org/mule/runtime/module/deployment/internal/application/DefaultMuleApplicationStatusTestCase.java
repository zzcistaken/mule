...
public class DefaultMuleApplicationStatusTestCase extends AbstractMuleContextTestCase {
  ...
  protected void doSetUp() throws Exception {
    ...
    application.setMuleContext(AbstractMuleContextTestCase.muleContext);
  }
  ...
  public void initialised() {
    ...
    AbstractMuleContextTestCase.muleContext
        .fireNotification(new MuleContextNotification(AbstractMuleContextTestCase.muleContext,
  ...
  public void started() throws Exception {
    AbstractMuleContextTestCase.muleContext.start();
  ...
  public void stopped() throws Exception {
    AbstractMuleContextTestCase.muleContext.start();
    AbstractMuleContextTestCase.muleContext.stop();
    assertStatus(ApplicationStatus.STOPPED);
  }

  @Test
  public void destroyed() {
    AbstractMuleContextTestCase.muleContext.dispose();
