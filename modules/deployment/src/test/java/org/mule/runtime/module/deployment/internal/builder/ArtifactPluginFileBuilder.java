...
public class ArtifactPluginFileBuilder extends AbstractArtifactFileBuilder<ArtifactPluginFileBuilder> {
  ...
  public ArtifactPluginFileBuilder dependingOn(String pluginName) {
    ...
    String plugins = properties.getProperty(ArtifactPluginDescriptorFactory.PLUGIN_DEPENDENCIES);
    if (isEmpty(plugins)) {
      plugins = pluginName;
    } else {
    ...
    properties.setProperty(ArtifactPluginDescriptorFactory.PLUGIN_DEPENDENCIES, plugins);
