...
public class ArtifactPluginDescriptorFactoryTestCase extends AbstractMuleTestCase {
  ...
  public void setUp() throws Exception {
    when(classLoaderFilterFactory.create(null, null))
        .thenReturn(DefaultArtifactClassLoaderFilter.NULL_CLASSLOADER_FILTER);
  }
  ...
  private static class PluginPropertiesBuilder {
    ...
    public File build() throws IOException {
      final File pluginProperties = new File(pluginFolder, ArtifactPluginDescriptorFactory.PLUGIN_PROPERTIES);
      ...
      addDescriptorProperty(pluginProperties, ArtifactPluginDescriptorFactory.PROPERTY_LOADER_OVERRIDE, this.overrides);
