...
@Configurations({HeisenbergExtension.class, AnnotationsBasedDescriberTestCase.NamedHeisenbergAlternateConfig.class})
@Operations({HeisenbergOperations.class, MoneyLaunderingOperation.class})
public class HeisengergPointerPlusExternalConfig
{
