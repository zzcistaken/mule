      ...
      new IdempotentDeclarationWalker() {
        ...
        public void onOperation(OperationDeclaration declaration) {
          ...
          if (implementingProperty.isPresent()) {
            final Optional<ConnectivityModelProperty> connectivityModelProperty = addModelProperty(declaration, implementingProperty.get().getMethodElement());
        ...
        public void onSource(SourceDeclaration declaration) {
          declaration.getModelProperty(ImplementingTypeModelProperty.class)
              .ifPresent(implementingProperty -> addModelProperty(declaration, (WithParameters) implementingProperty.getTypeEle()));
        }
  ...
  private Optional<ConnectivityModelProperty> addModelProperty(BaseDeclaration declaration, WithParameters methodWrapper) {
    ...
    if (!connectionParameters.isEmpty()) {
      ConnectivityModelProperty modelProperty =
          new ConnectivityModelProperty(STRING_TYPE);
