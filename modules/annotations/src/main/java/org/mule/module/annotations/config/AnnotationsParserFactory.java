 ...
 * LICENSE.txt file.
 */
package org.mule.module.annotations.config;
...
import org.mule.module.annotations.api.expression.ExpressionAnnotationParser;
...
public interface AnnotationsParserFactory
{
     ...
     * the {@link org.mule.module.annotations.api.annotations.meta.Evaluator} annotation.
     * <p/>
     *
     * @param annotation the annotation being processed
     ...
     * the {@link org.mule.module.annotations.api.annotations.meta.Router} annotation. the parameters passed in can be used to validate the use of
     * the annotation, i.e. you may want to restrict annotations to only be configured on concrete classes.
     * <p/>
     *
     * @param annotation the annotation being processed
