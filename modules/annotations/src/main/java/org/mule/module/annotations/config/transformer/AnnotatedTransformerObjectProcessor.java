 ...
 * LICENSE.txt file.
 */
package org.mule.module.annotations.config.transformer;
...
/**
 * Will check all method level annotations to see if there are any {@link org.mule.module.annotations.api.annotations.Transformer} annotations present.
 * For each method annotated with {@link org.mule.module.annotations.api.annotations.Transformer} a Mule transformer will be created.  When the
 * transformer is used, the method will get invoked
 *
 * @see org.mule.module.annotations.api.annotations.Transformer
 */
