...
import org.mule.module.extension.spring.internal.resources.ExtensionResourcesGeneratorAnnotationProcessor;
...
public final class SchemaDocumenterModelEnricher implements ModelEnricher
{
    ...
    {
        ProcessingEnvironment processingEnv = describingContext.getParameter(ExtensionResourcesGeneratorAnnotationProcessor.PROCESSING_ENVIRONMENT, ProcessingEnvironment.class);
        TypeElement extensionElement = describingContext.getParameter(ExtensionResourcesGeneratorAnnotationProcessor.EXTENSION_ELEMENT, TypeElement.class);
        RoundEnvironment roundEnvironment = describingContext.getParameter(ExtensionResourcesGeneratorAnnotationProcessor.ROUND_ENVIRONMENT, RoundEnvironment.class);
