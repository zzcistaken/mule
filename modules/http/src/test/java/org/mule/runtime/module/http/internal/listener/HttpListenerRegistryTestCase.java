...
public class HttpListenerRegistryTestCase extends AbstractMuleTestCase {
  ...
  public void noPathFound() {
    httpListenerRegistry = new HttpListenerRegistry(null, null, messageProcessingManager);
  ...
  private HttpListenerRegistry createHttpListenerRegistryWithRegisteredHandlers() {
    final HttpListenerRegistry httpListenerRegistry = new HttpListenerRegistry(null, null, messageProcessingManager);
