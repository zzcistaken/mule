...
public class HttpListenerResponseSender
{
    ...
    public HttpListenerResponseSender(Transformer objectToByteArrayTransformer)
    {
        this.responseFactory = new HttpResponseFactory(HttpStreamingType.NEVER, objectToByteArrayTransformer);
    }
