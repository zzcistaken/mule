...
public class JmsOperations
{
     ...
     * level lock will be placed on the file until the {@link java.io.InputStream} returned
     * by the {@link org.mule.module.extension.file.api.FilePayload#getContent()} this operation returns is closed or
     ...
     * {@code true} on the {@code contentMetadata} argument, a {@link javax.activation.MimetypesFileTypeMap}
     ...
     *
     * @param fileSystem      a reference to the host {@link org.mule.module.extension.file.api.FileSystem}
     ...
     * @return the file's content and metadata on a {@link org.mule.module.extension.file.api.FilePayload} instance
     ...
     * @param mode                  a {@link org.mule.module.extension.file.api.FileWriteMode}. Defaults to {@code OVERWRITE}
     * @param lock                  whether or not to lock the file. Defaults to {@code false}
