...
public class MinimalApplicationModelGeneratorTestCase extends AbstractMuleTestCase
{
    ...
    {
        Optional<ConfigLine> configLine = xmlApplicationParser.parse(documentLoader.loadDocument(getClass().getClassLoader().getResourceAsStream("model-generator/" + configFileName)).getDocumentElement());
        ...
        CoreComponentBuildingDefinitionProvider coreComponentBuildingDefinitionProvider = new CoreComponentBuildingDefinitionProvider();
        ...
        return new MinimalApplicationModelGenerator(new ApplicationModel(new ArtifactConfig.Builder().addConfigFile(configFile).build(), new ArtifactConfiguration(emptyList()), Optional.of(componentBuildingDefinitionRegistry)), componentBuildingDefinitionRegistry);
    }
