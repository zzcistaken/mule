...
import org.mule.config.spring.ContentDefinitionDefinitionParser;
import org.mule.config.spring.FlowVariableDefinition;
import org.mule.config.spring.MessageContentDefinition;
import org.mule.config.spring.MessageContentDefinitionDefinitionParser;
import org.mule.config.spring.PayloadContentDefinition;
import org.mule.config.spring.PropertyDefinition;
import org.mule.config.spring.SessionVariableDefinition;
...
public class MuleNamespaceHandler extends AbstractMuleNamespaceHandler
{
    ...
    public void init()
    {
        ...
        registerBeanDefinitionParser("session-variable", new ContentDefinitionDefinitionParser(SessionVariableDefinition.class));
