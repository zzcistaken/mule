...
import org.mule.config.spring.factories.FlowFactoryBean;
...
public class NewFlowDefinitionParser extends OrphanDefinitionParser
{
    public NewFlowDefinitionParser()
    {
        super(FlowFactoryBean.class, true);
        addIgnored("abstract");
        addIgnored("name");
    ...
    {
        builder.addPropertyValue("name", element.getAttribute(ATTRIBUTE_NAME));
