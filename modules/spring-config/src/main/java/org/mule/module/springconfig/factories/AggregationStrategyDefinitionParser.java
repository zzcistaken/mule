...
public class AggregationStrategyDefinitionParser extends ChildDefinitionParser
{
    ...
    public AggregationStrategyDefinitionParser()
    {
        ...
        this.registerPreProcessor(new CheckExclusiveAttribute(org.mule.module.springconfig.parsers.AbstractMuleBeanDefinitionParser.ATTRIBUTE_CLASS));
        this.registerPreProcessor(new CheckExclusiveAttribute(org.mule.module.springconfig.parsers.AbstractMuleBeanDefinitionParser.ATTRIBUTE_REF));
    }
    ...
    protected Class<?> getBeanClass(Element element)
    {
        ...
        {
            if (element.hasAttribute(org.mule.module.springconfig.parsers.AbstractMuleBeanDefinitionParser.ATTRIBUTE_REF))
            {
