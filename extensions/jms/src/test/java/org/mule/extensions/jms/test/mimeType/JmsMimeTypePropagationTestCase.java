...
public class JmsMimeTypePropagationTestCase extends JmsAbstractTestCase {
  ...
  private static final MediaType APPLICATION_JSON_MEDIA_TYPE = MediaType.create("application", "json", Charset.forName("ISO-8859-1"));
  ...
  @Parameters(name = "Publish: {0} --> Expect: {1}")
  public static Collection<Object[]> data() {
    return asList(new Object[][] {
        {APPLICATION_JSON_MEDIA_TYPE, APPLICATION_JSON_MEDIA_TYPE, CONSUMER_FLOW, LISTENER_FLOW, PUBLISH_CONSUMER_FLOW},
        {null, DEFAULT_MEDIA_TYPE, CONSUMER_FLOW, LISTENER_FLOW, PUBLISH_CONSUMER_FLOW},
        {null, TEXT_JSON_MEDIA_TYPE, CONSUMER_FLOW + WITH_OVERRIDE, LISTENER_FLOW + WITH_OVERRIDE, PUBLISH_CONSUMER_FLOW + WITH_OVERRIDE}
