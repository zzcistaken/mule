...
public interface JmsSupport
{
     ...
     * @throws JMSException
     */
    Destination createDestinationFromAddress(Session session, String address, boolean isTopic) throws JMSException;

    Destination createTemporaryDestination(Session session, boolean topic) throws JMSException;

    void send(MessageProducer producer, Message message, boolean persistentDelivery, boolean topic) throws JMSException;
    ...
    void send(MessageProducer producer, Message message, boolean persistentDelivery, Destination dest, boolean topic) throws JMSException;
