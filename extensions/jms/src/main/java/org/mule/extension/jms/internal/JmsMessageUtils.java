 ...
 * LICENSE.txt file.
 */
package org.mule.extension.jms.internal;
...
public class JmsMessageUtils
{
        ...
        for (Iterator<?> iter = value.iterator(); iter.hasNext();)
        {
            ...
            else
            {
                throw new MessageFormatException(String.format(
                        ...
                        + "String and byte[]", getClassName(o)));
            }
        }
        return sMsg;
    }
    ...
    public static Object toObject(Message message, JmsSupport.JmsSpecification jmsSpec) throws JMSException, IOException
    {
        ...
        else if (message instanceof BytesMessage)
        {
            ...
            if (JmsSupport.JmsSpecification.JMS_1_1.equals(jmsSpec))
            {
     ...
     */
    public static byte[] toByteArray(Message message, JmsSupport.JmsSpecification jmsSpec, String encoding) throws JMSException, IOException
    {
