...
public class HttpListenerConfig extends HttpConfig implements Initialisable, MuleContextAware, Startable, Stoppable
{
    ...
    @Parameter
    @Optional
    private Boolean parseRequest = true;
    ...
    HttpListenerConfig(HttpListenerConnectionManager connectionManager)
    {
    ...
    public synchronized void initialise() throws InitialisationException
    {
        ...
        connectionManager = muleContext.getRegistry().get("_httpExtListenerConnectionManager");
    ...
    {
        final WorkManager workManager = workerThreadingProfile.createWorkManager(format("%s%s.%s", ThreadNameHelper.getPrefix(muleContext), "DEADPOOL", "worker"), muleContext.getConfiguration().getShutdownTimeout());
    ...
    {
        return String.format("%s://%s:%d%s", getProtocol(), getHost(), getPort(), StringUtils.defaultString(basePath));
    }
