...
public class FunctionalTestComponent implements Callable, Initialisable, Disposable, MuleContextAware, Receiveable, Startable, Stoppable
{
    ...
    /**
     * Always throws a {@link org.mule.functional.exceptions.FunctionalTestException}.  This methodis only called if
     * {@link #isThrowException()} is true.
     *
     * @throws org.mule.functional.exceptions.FunctionalTestException or the exception specified in 'exceptionType
     */
