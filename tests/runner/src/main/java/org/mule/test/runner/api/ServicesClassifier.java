 ...
 */
public class ServicesClassifier extends AbstractArtifactClassifier<ArtifactClassification> {
  ...
  public List<ArtifactClassification> classify(DependencyResolver dependencyResolver, ClassPathClassifierContext context,
    ...
    List<ArtifactClassification> serviceClassifications = toServiceUrlClassification(servicesClassified.values());
    serviceClassifications.stream().forEach(serviceClassified -> context.addServiceClassification(serviceClassified));
