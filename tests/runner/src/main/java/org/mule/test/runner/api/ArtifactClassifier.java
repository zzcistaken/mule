 ...
 * @since 4.0
 */
public interface ArtifactClassifier<T extends ArtifactClassification> {
   ...
   * @return the result of the classification {@link ArtifactClassification}
   */
  //TODO: just a context should be passed here, the rest of the entities should be obtained from the context and the resolver injected to the classifier implementation!
