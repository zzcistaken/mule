...
public class DefaultSchedulerServiceTestCase extends AbstractMuleTestCase {
  ...
  @Test
  @Description("Tests that tasks dispatched from an IO thread to a busy Scheduler wait for execution.")
  ...
  @Test
  @Description("Tests that tasks dispatched from a Custom scheduler thread to a busy Scheduler wait for execution.")
