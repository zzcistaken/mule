...
public class RestrictedSSLServerSocketFactory extends SSLServerSocketFactory
{
    ...
    public RestrictedSSLServerSocketFactory(SSLContext sslContext, String[] cipherSuites, String[] protocols)
    {
        ...
        {
            logger.warn("Current context supports less SSL protocols than configured. Only the following are enabled: [{}]", join(this.enabledProtocols));
        }
    }

    private String join(String[] enabledProtocols)
    {
        ...
        for (int i =0; i< enabledProtocols.length;i++)
        {
            ...
            builder.append(enabledProtocols[i]);
        }
