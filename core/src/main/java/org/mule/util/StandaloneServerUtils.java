...
public class StandaloneServerUtils
{
    ...
    /**
     * @return the MULE_BASE directory of this instance. Returns the {@link org.mule.api.config.MuleProperties#MULE_HOME_DIRECTORY_PROPERTY} property value if {@link org.mule.api.config.MuleProperties#MULE_BASE_DIRECTORY_PROPERTY} is not set which may be null.
     */
