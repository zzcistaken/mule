...
public class ActivitiNamespaceHandlerTestCase extends FunctionalTestCase
{
    ...
    public void testActivitiConfig() throws Exception
    {
        ...
        Service service = muleContext.getRegistry().lookupService("Activiti service");
        InboundEndpoint endpoint = (InboundEndpoint) service.getInboundRouter().getEndpoints().get(0);
        ListProcessDefinitionsAction action = (ListProcessDefinitionsAction) endpoint.getProperty("action");
