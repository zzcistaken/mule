...
/**
 * Tests the connector against jBPM with a simple process.  The ProcessEngine is built by Spring and injected into the Mule wrapper.
 * 
 * @deprecated It is recommended to configure BPM as a component rather than a transport for 3.x
 */
public class SpringJbpmTestCase extends FunctionalTestCase
{

    protected String getConfigResources()
    {
        return "spring-jbpm-functional-test.xml";
    }
