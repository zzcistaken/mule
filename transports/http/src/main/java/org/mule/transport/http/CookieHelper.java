...
public class CookieHelper
{
        ...
        throws MalformedCookieException
    {
        ...
        Cookie[] cookieArray = cookieSpec.parse(uri.getHost(), uri.getPort(), uri.getPath(), false,
            cookieHeaderValue);
        return cookieArray;
    }
    ...
    public static Cookie[] parseCookiesAsAServer(Header header)
    {
        ...
        mimeHeaders.addValue(HttpConstants.HEADER_COOKIE).setBytes(value.getBytes(), 0, value.length());
