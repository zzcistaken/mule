...
public class TcpRemoteSyncTestCase extends DynamicPortTestCase
{
   ...
   public void testTcpTcpRemoteSync() throws Exception
   {
       ...
       MuleMessage reply = client.send(((InboundEndpoint) client.getMuleContext().getRegistry().lookupObject("echoInTcp")).getEndpointURI().getAddress(), new DefaultMuleMessage(message), props);
    ...
    public void testTcpVmRemoteSync() throws Exception
    {
        ...
        MuleMessage reply = client.send(((InboundEndpoint) client.getMuleContext().getRegistry().lookupObject("echo2InTcp")).getEndpointURI().getAddress(), new DefaultMuleMessage(message), props);
